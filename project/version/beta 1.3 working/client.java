...
class ControlClientThread extends Thread
{
    ...
    public void run()
    {
        ...
        while (true)
        {
           ...
           // System.out.println("serverFilesPaths:  " + serverFilesPaths);
           // System.out.println("serverFileNames:  " + serverFileNames);
            //System.out.println("servera:  " + serverFilesForUser);
            //System.out.println("clienta:  " + clientFileNames);
...
public class client
{
    ...
    public client(String address, int port, String userName, String filePath)
    {
        ...
        try
        {
            clientDirectoryPath = Paths.get(filePath); //Paths.get("C:/java/client");
